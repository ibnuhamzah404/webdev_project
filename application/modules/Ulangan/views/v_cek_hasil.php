              ...
              <div class="card-body">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled  user-progress list-unstyled-border li st-unstyled-noborder d-flex  justify-content-between flex-wrap">
                      
                         <?php foreach($data_siswa_belum as $siswa_b): ?>
                         <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="<?=base_url().'/assets/customer/img/avatar/avatar-1.png' ?>">
                        <div class="media-body">
                          <div class="media-title"><?= $siswa_b->nama  ?></div>
                          <div class="text-job text-danger "><?= $siswa_b->id_kelas ?></div>
                ...
                <div class="card">
                  ...
                  <div class="card-body" style="padding : 0">
                    ...
                    <ul class="list-unstyled  user-progress list-unstyled-border list-unstyled-noborder d-flex  justify-content-between flex-wrap">
                      ...
                      <?php foreach($data_siswa_sudah as $siswa_s): ?>
                          <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="<?=base_url().'/assets/customer/img/avatar/avatar-1.png' ?>">
                        <div class="media-body">
                          <div class="media-title"><?= $siswa_s->nama  ?></div>
                          <div class="text-job text-danger "><?= $siswa_s->id_kelas ?></div>

                          <a href="<?= base_url().'Ulangan/detail_hasil/' . $siswa_s->id_hasil_ulangan ?>" class="mt-2 btn btn-sm btn-warning">detail</a>
